package forms.bank.abnamro.Gateway;
...
public class BankClientAppGateway {
    ...
    protected BankClientAppGateway(){
        ...
        MessageReceiverGateway receiver = new MessageReceiverGateway(Constants.ABN_BANK_INTEREST_REQUEST, Constants.ABN_BANK_INTEREST_REQUEST_QUEUE);
